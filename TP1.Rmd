...
- effectuer un triage pour déterminer la nature de l’incident -- s’il s’agit d’un vrai positif, d’un faux positif ou d’un positif bénin ; 
...
Les variables sont réparties en 31 numériques et 15 catégorielles. L’objectif de cette base est de détecter des anomalies et prédire des attaques informatiques en fonctions de ces variables.
...
-ThreatFamily : Famille de la menace détectée
